...
export LIVEWEB_FORMAT_RECOVERY_MAX_NEW_TOKENS="${LIVEWEB_FORMAT_RECOVERY_MAX_NEW_TOKENS:-96}"
export LIVEWEB_FORMAT_RECOVERY_TEMPERATURE="${LIVEWEB_FORMAT_RECOVERY_TEMPERATURE:-0.35}"
...
if [[ "${LIVEWEB_LOAD_BASE_FROM_HF_IF_EMPTY}" == "1" ]] && ! dir_is_nonempty "${LOAD_CHECKPOINT_DIR}"; then
