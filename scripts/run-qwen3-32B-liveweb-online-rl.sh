...
case "${TRAIN_PHASE}" in
  preflight)
    ...
    set_default_if_unset LIVEWEB_MAX_COMPLETION_TOKENS 512
  ...
  warmup)
    ...
    set_default_if_unset ROLLOUT_BATCH_SIZE 6
    set_default_if_unset N_SAMPLES_PER_PROMPT 8
    set_default_if_unset GLOBAL_BATCH_SIZE 12
    set_default_if_unset TRAIN_DYNAMIC_GLOBAL_BATCH_SIZE_CAP 12
    set_default_if_unset TRAIN_MIN_DYNAMIC_GLOBAL_BATCH_SIZE 8
    set_default_if_unset TRAIN_MAX_SAMPLES_PER_ROLLOUT 0
    set_default_if_unset LIVEWEB_MAX_COMPLETION_TOKENS 768
  ...
  main)
    ...
    set_default_if_unset ROLLOUT_BATCH_SIZE 8
    set_default_if_unset N_SAMPLES_PER_PROMPT 8
    ...
    set_default_if_unset TRAIN_MAX_SAMPLES_PER_ROLLOUT 64
    set_default_if_unset LIVEWEB_MAX_COMPLETION_TOKENS 1024
...
if [[ "${LIVEWEB_RUN_MODE}" == "fresh" && "${LIVEWEB_LOAD_BASE_FROM_HF_IF_EMPTY}" == "1" ]] && ! dir_is_nonempty "${LOAD_CHECKPOINT_DIR}"; then
  ...
  REF_MODEL_LOAD_DIR="${HF_MODEL_DIR}"
fi
